...
public class SampleData {
	...
	public static Country australia = new Country(population.nextInt(), squareKm.nextInt(), "Australia", Lists.newArrayList(melbourne, sydney, perth));
	...
	public static Country us = new Country(population.nextInt(), squareKm.nextInt(), "U.S.A.", Lists.newArrayList(newyork, boston, sanfrancisco));
